...
var today = "Monday"; // Monday is garbage
...
var peanutsGang = ['Snoopy', 'Gandalf', 'Harry Potter', 'Batman', 'Snoopy again'];
console.log(peanutsGang);
console.log(peanutsGang[1]);
...
var evenSavings = newSavings%2 == 0;
console.log(evenSavings);
var prizeSavings = newSavings+500;
console.log(prizeSavings);
...
var tax = 500*0.3;
var taxedSavings = prizeSavings - tax;
console.log(taxedSavings);
...
var interestPerQuarter = taxedSavings*0.005;
var savingsInterest = taxedSavings + interestPerQuarter;
...
var decreasedBit = newBitTotal--;
console.log(decreasedBit);